...
export default function Header() {
  ...
  // state to track if the menu is open or open
    ...
    <header className="absolute w-full z-50 transition-all duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          {/* Social Icons + Hire Me Button Container */}
      ...
      >
        <nav className="flex flex-col space-y-3">
          {["Home", "About", "Project", "Experience", "Contact"].map((item) => (
            <a
              onClick={toggleMenu}
              className="text-gray-300 hover:text-violet-400 font-medium py-2 transition-colors duration-300"
              key={item}
              href="#"
            >
              {item}
              ...
              <form action="" className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700"
                  />
                </div>
                <div>
                  <label
